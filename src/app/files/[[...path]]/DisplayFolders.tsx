...
export default function DisplayFolders({ defaultTab}: { defaultTab: string }) {
    ...
    const [data, setData] = useState<getDirResponse>({FileType: FileType.Folder, Files: []});
    ...
    return (
    <>  
    <Tabs defaultValue={defaultTab} onValueChange={onValueChange} className="p-2" >
        <TabsList >
            <TabsTrigger value="grid"><LayoutGrid /></TabsTrigger>
            <TabsTrigger value="list"><List /></TabsTrigger>
            <TabsTrigger value="tree"><ListCollapse /></TabsTrigger>
        </TabsList>
        <div className="pt-2 "><Separator ></Separator></div>
